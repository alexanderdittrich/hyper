...
register(
    ...
    entry_point="environments.wrappers:mujoco_wrapper",
    kwargs={
        "entry_point": "environments.mujoco.half_cheetah_hop:HalfCheetahHopEnv",
        "max_episode_steps": 200,
    },
    max_episode_steps=200,
)
...
register(
    ...
    entry_point="environments.wrappers:mujoco_wrapper",
    kwargs={
        "entry_point": "environments.mujoco.ant_goal_sparse:AntGoalSparseEnv",
        "max_episode_steps": 200,
        "level": 4,
    },
    max_episode_steps=200,
...
register(
    ...
    kwargs={
        "maze_size": 3,
        "just_show_whether_at_goal": True,
    },
)
