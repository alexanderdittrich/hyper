...
from environments.garage.np.policies import Policy
from environments.garage.sampler import Sampler
from environments.garage.torch import np_to_torch
    ...
    def __init__(
        ...
        *,
        ...
        self._optimizer = make_optimizer(
            policy_optimizer, module=self.learner, lr=policy_lr
        )
    ...
    def train(self, trainer):
        ...
        for epoch in trainer.step_epochs():
            if self._eval_env is not None:
                log_performance(
                    epoch,
                    obtain_evaluation_episodes(self.learner, self._eval_env),
                    discount=1.0,
                )
