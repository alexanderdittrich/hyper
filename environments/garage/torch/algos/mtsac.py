...
from environments.garage import (EpisodeBatch, log_multitask_performance,
                    obtain_evaluation_episodes)
from environments.garage.torch import global_device
from environments.garage.torch.algos import SAC
    ...
    def __init__(
        ...
        *,
        ...
        if self._use_automatic_entropy_tuning:
            ...
            self._alpha_optimizer = optimizer(
                [self._log_alpha] * self._num_tasks, lr=self._policy_lr
            )
        else:
