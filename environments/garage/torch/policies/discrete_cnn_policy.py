...
from environments.garage.torch.modules import DiscreteCNNModule
from environments.garage.torch.policies.stochastic_policy import StochasticPolicy
...
class DiscreteCNNPolicy(StochasticPolicy):
    ...
    def __init__(
        ...
        self._is_image = isinstance(self._env_spec.observation_space, akro.Image)
