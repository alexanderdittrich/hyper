...
from environments.garage.tf.models import GaussianMLPModel


class GaussianMLPBaselineModel(GaussianMLPModel):
    """GaussianMLPBaseline based on garage.tf.models.Model class.
