...
from environments.garage.torch.algos import MAMLPPO
...
def maml_ppo_half_cheetah_dir(ctxt, seed, epochs, episodes_per_task, meta_batch_size):
    ...
    env = normalize(
        GymEnv(HalfCheetahDirEnv(), max_episode_length=max_episode_length),
    ...
    meta_evaluator = MetaEvaluator(
        test_task_sampler=task_sampler, n_test_tasks=2, n_test_episodes=10
    )
