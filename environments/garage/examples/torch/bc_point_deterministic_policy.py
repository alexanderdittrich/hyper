...
from environments.garage.envs import PointEnv
from environments.garage.sampler import RaySampler
from environments.garage.torch.algos import BC
from environments.garage.torch.policies import DeterministicMLPPolicy, Policy
...
class OptimalPolicy(Policy):
    ...
    def get_actions(self, observations):
        ...
        """
        return (
            self.goal[np.newaxis, :].repeat(len(observations), axis=0)
            - observations[:, :2]
        ), {}
