...
from environments.garage.np.exploration_policies import AddGaussianNoise
from environments.garage.np.policies import UniformRandomPolicy
...
from environments.garage.torch import prefer_gpu
from environments.garage.torch.algos import TD3
from environments.garage.torch.policies import DeterministicMLPPolicy
...
def td3_pendulum(ctxt=None, seed=1):
    ...
    exploration_policy = AddGaussianNoise(
        env.spec, policy, total_timesteps=num_timesteps, max_sigma=0.1, min_sigma=0.1
    )
