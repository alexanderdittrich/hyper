...
from environments.garage.tf.baselines import GaussianCNNBaseline
from environments.garage.tf.policies import CategoricalCNNPolicy
...
def trpo_cubecrash(ctxt=None, seed=1, max_episode_length=5, batch_size=4000):
    ...
    with TFTrainer(ctxt) as trainer:
        env = normalize(GymEnv("CubeCrash-v0", max_episode_length=max_episode_length))
