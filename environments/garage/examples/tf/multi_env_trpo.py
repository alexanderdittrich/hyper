...
from environments.garage.envs import normalize, PointEnv
...
def multi_env_trpo(ctxt=None, seed=1):
    ...
    with TFTrainer(ctxt) as trainer:
        env1 = normalize(PointEnv(goal=(-1.0, 0.0), max_episode_length=100))
        env2 = normalize(PointEnv(goal=(1.0, 0.0), max_episode_length=100))
