...
from environments.metaworld_v2.metaworld.envs.mujoco.env_dict import (
    ALL_V1_ENVIRONMENTS,
    ALL_V2_ENVIRONMENTS,
)
from environments.metaworld_v2.metaworld.policies import *
...
def test_scripted_policy(env, policy, act_noise_pct, expected_success_rate, iters=100):
    ...
    """
    assert len(vars(policy)) == 0, "{} has state variable(s)".format(
