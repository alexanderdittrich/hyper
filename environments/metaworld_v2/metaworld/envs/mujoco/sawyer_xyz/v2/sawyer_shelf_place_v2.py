...
from environments.metaworld_v2.metaworld.envs import reward_utils
from environments.metaworld_v2.metaworld.envs.asset_path_utils import full_v2_path_for
...
class SawyerShelfPlaceEnvV2(SawyerXYZEnv):
    ...
    def evaluate_state(self, obs, action):
        obj = obs[4:7]
        reward, tcp_to_obj, tcp_open, obj_to_target, grasp_reward, in_place = (
    ...
    def reset_model(self):
        ...
        if self.random_init:
            ...
            self.sim.model.body_pos[self.model.body_name2id("shelf")] = base_shelf_pos[
                -3:
            ]
            self._target_pos = (
                self.sim.model.site_pos[self.model.site_name2id("goal")]
