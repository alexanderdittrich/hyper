...
def get_args(rest_args):
    ...
    parser.add_argument(
        "--num_frames", type=int, default=15e6, help="number of frames to train"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--env_name", default="GridNavi-v0", help="environment to train on"
    )
    ...
    parser.add_argument(
        "--lr_policy", type=float, default=0.0007, help="learning rate (default: 7e-4)"
    )
    parser.add_argument(
        "--num_processes",
        type=int,
    ...
    parser.add_argument(
        "--policy_gamma", type=float, default=0.95, help="discount factor for rewards"
    )
    parser.add_argument(
        "--policy_use_gae",
        type=boolean_argument,
    ...
    parser.add_argument(
        "--kl_weight", type=float, default=1, help="weight for the KL term"
    )
    ...
    parser.add_argument(
        "--reward_decoder_layers", nargs="+", type=int, default=[32, 32]
    )
    parser.add_argument(
