...
def get_args(rest_args):
    ...
    # variBAD
    parser.add_argument(
        "--exp_label", default="varibad", help="label for the experiment"
    )
    parser.add_argument(
        "--disable_varibad",
    ...
    # env
    parser.add_argument(
        "--env_name", default="SemicircleEnv-v0", help="environment to train on"
    )
    ...
    # algo
    parser.add_argument(
        "--policy_optimiser", type=str, default="rmsprop", help="choose: adam, rmsprop"
    )
    parser.add_argument(
        "--policy_alpha",
        type=float,
    ...
    parser.add_argument(
        "--lr_policy", type=float, default=3e-4, help="learning rate (default: 7e-4)"
    )
    parser.add_argument(
        "--policy_num_steps",
        type=int,
    ...
    parser.add_argument(
        "--policy_tau", type=float, default=0.9, help="gae parameter (default: 0.95)"
    )
    parser.add_argument(
        "--use_proper_time_limits", type=boolean_argument, default=False
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="prob of adding a new traj to buffer",
    )
    ...
    parser.add_argument(
        ...
        type=int_or_none,
        default=None,
        help="stepsize for truncated backpropagation through time; None uses maximum (horizon of BAMDP)",
    )
    parser.add_argument(
        "--vae_subsample_elbos",
        type=int,
        default=None,
        help="number of elbos to subsample",
    )
    parser.add_argument(
        "--vae_subsample_decodes",
        type=int,
        default=None,
        help="number of reconstruction terms to subsample",
    )
    parser.add_argument(
        "--num_vae_updates",
        type=int,
    ...
    parser.add_argument(
        "--input_action", type=boolean_argument, default=True, help="use reward decoder"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=float,
        default=1.0,
        help="weight for task loss (vs other losses)",
    )
    ...
    parser.add_argument(
        "--disable_stochasticity_in_latent", type=boolean_argument, default=False
    )
    parser.add_argument(
        "--sample_embeddings",
        type=boolean_argument,
    ...
    parser.add_argument(
        ...
        type=boolean_argument,
        default=False,
        help="split batches up by task (to save memory)",
    )
    parser.add_argument(
        "--split_batches_by_elbo",
        type=boolean_argument,
        default=False,
        help="split batches up by elbo term (to save memory)",
    )
