...
def get_args(rest_args):
    ...
    parser.add_argument("--ml1_type", default="reach", help="push/pick-place/reach")
    parser.add_argument(
    ...
    parser.add_argument(
        "--reward_decoder_layers", nargs="+", type=int, default=[64, 32]
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--decode_state", type=boolean_argument, default=False, help="use state decoder"
    )
    parser.add_argument(
