...
def get_args(rest_args):
    ...
    parser.add_argument(
        "--num_frames", type=int, default=1e8, help="number of frames to train"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--exp_label", default="varibad", help="label (typically name of method)"
    )
    parser.add_argument(
        "--env_name", default="metaworld_ml10", help="environment to train on"
    )
    parser.add_argument(
        "--mw_version", type=int, default=2, help="version of meta-world"
    )
    parser.add_argument(
    ...
    parser.add_argument("--policy_state_embedding_dim", type=int_or_none, default=64)
    parser.add_argument("--policy_latent_embedding_dim", type=int_or_none, default=64)
    ...
    # NEW: trying to deal with exploding losses
    parser.add_argument("--vae_squash_targets", type=boolean_argument, default=True)
