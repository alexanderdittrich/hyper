...
def get_args(rest_args):
    ...
    parser.add_argument(
        "--env_name", default="AntGoal-v0", help="environment to train on"
    )
    ...
    parser.add_argument(
        "--lr_policy", type=float, default=1e-3, help="learning rate (default: 7e-4)"
    )
    parser.add_argument(
        "--num_processes",
        type=int,
    ...
    parser.add_argument(
        "--kl_weight", type=float, default=0.1, help="weight for the KL term"
    )
