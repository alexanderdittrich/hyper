...
def get_args(rest_args):
    ...
    parser.add_argument(
        "--env_name", default="Walker2DRandParams-v0", help="environment to train on"
    )
    ...
    parser.add_argument(
        "--ppo_clip_param", type=float, default=0.05, help="clamp param"
    )
    ...
    parser.add_argument(
        "--latent_dim", type=int, default=10, help="dimensionality of latent space"
    )
    ...
    parser.add_argument(
        "--reward_decoder_layers", nargs="+", type=int, default=[256, 64]
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--state_decoder_layers", nargs="+", type=int, default=[256, 128]
    )
    parser.add_argument(
        "--state_pred_type",
        type=str,
